            ...
            @foreach($leaveRequests as $leaveRequest)
                <tr>
                    ...
                    <td  style="width: 120px">
                        {!! Form::open(['route' => ['leaveRequests.destroy', $leaveRequest->id], 'method' => 'delete']) !!}
                        <div class='btn-group'>
                            <a href="{{ route('leaveRequests.show', [$leaveRequest->id]) }}"
                               class='btn btn-default btn-xs'>
                                <i class="far fa-eye"></i>
                            </a>
                            <a href="{{ route('leaveRequests.edit', [$leaveRequest->id]) }}"
                               class='btn btn-default btn-xs'>
